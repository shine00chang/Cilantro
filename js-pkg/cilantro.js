import { get_lib } from './snippets/cilantro-e6d3cf389f603ea0/web/lib-getter.js';
...
* @returns {string}
*/
export function compile_web(source) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        wasm.compile_web(retptr, ptr0, len0);
...
* feature.
* @param {string} wat_str
* @returns {Uint8Array}
*/
export function tobytes(wat_str) {
    const ptr0 = passStringToWasm0(wat_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.tobytes(ptr0, len0);
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_getlib_7d009ecc18a0f438 = function() { return logError(function (arg0) {
        const ret = get_lib();
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('cilantro_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
